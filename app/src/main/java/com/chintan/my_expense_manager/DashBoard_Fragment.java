...
import com.chintan.my_expense_manager.Model.Data;
...
public class DashBoard_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_dash_board_, container, false);
        ...
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot mysnap: snapshot.getChildren()){
                    ...
                    totalIncomResult.setText("Rs. "+stResult+".00");
        ...
        mExpenseDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot mysnap: snapshot.getChildren()){
                    ...
                    totalExpenseResult.setText("Rs. "+stResult+".00");
                }
            }
    ...
    public void insertIncomeData(){
        ...
        View myview=inflater.inflate(R.layout.custom_layout_for_insertion, null);
    ...
    public static class IncomeViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setIncomeAmount(int amount){
            ...
            mAmount.setText("Rs. "+strAmount+".00");
        }
