...
import com.chintan.my_expense_manager.Model.Data;import com.firebase.ui.database.FirebaseRecyclerAdapter;
...
public class Income_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview =  inflater.inflate(R.layout.fragment_income_, container, false);
        ...
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot mysnapshot: snapshot.getChildren()){
                    ...
                    Log.d("CHIN", String.valueOf(incomeTotalSum));
                }
